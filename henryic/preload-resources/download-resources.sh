...
function download_broad {
    ...
    grep "a href" index.html | sed -e 's/.*<a href="\(.*\)">.*/\1/g' | grep -v \.bam | grep -v \.done | wget -N -
...
wget -r ftp://igenome:G3nom3s4u@ussd-ftp.illumina.com/Homo_sapiens/Ensembl/GRCh37/Homo_sapiens_Ensembl_GRCh37.tar.gz
...
wget -r ftp://igenome:G3nom3s4u@ussd-ftp.illumina.com/Homo_sapiens/UCSC/hg19/Homo_sapiens_UCSC_hg19.tar.gz
