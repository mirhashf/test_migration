...
for gatk_version in args.gatk_versions:
  for aligner in args.aligners:
    for dataset_name in dataset_names:
      ...
      tags = "%s,%s,%s,%s,%s,%s,%s" % (dataset_name, run_type, aligner, genotyper, "vqsr" if args.enable_vqsr else "no-vqsr", "sv" if (args.enable_sv and run_type == "wgs") else "no-sv", gatk_version)
